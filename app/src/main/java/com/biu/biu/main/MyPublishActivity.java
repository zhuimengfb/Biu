	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.setClass(MyPublishActivity.this,
						PeepDetailActivity.class);
				intent.putExtra("thread_id", mypublishlistitems.get(nPosition)
						.getThread_id());
				intent.putExtra("CanDeleteTip", true); // 打开删帖接口
				String strType = mypublishlistitems.get(nPosition)
						.getThread_type();
				if (strType.equals("0")) {
